          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing and using PhotoSelect, you accept and agree to be bound by the terms and provision of this agreement.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Permission is granted to temporarily use PhotoSelect for personal and commercial photography business purposes.
              </p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li>This license shall automatically terminate if you violate any of these restrictions</li>
                <li>You may not modify or copy the materials</li>
                <li>You may not use the materials for any commercial purpose without explicit permission</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-black mb-4">Content Ownership</h2>
              <p className="text-gray-700 mb-4">
                You retain all rights to photos and content you upload to PhotoSelect. We do not claim ownership of your content.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibent text-black mb-4">Termination</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:legal@photoselect.com" className="text-blue-600 hover:underline">
