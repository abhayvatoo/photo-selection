          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                At PhotoSelect, we collect information you provide directly to us, such as when you create an account, 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:privacy@photoselect.com" className="text-blue-600 hover:underline">
