...
export function ConfirmationModal({
  ...
  const canConfirm =
    !requiresTypedConfirmation || typedConfirmation === confirmationPhrase;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        {/* Content */}
        <div className="p-6">
          <p className="text-gray-700 whitespace-pre-line mb-4">{message}</p>

          {confirmText && (
            <div className="mb-4 p-3 bg-gray-50 rounded-md">
              <p className="text-sm text-gray-600 font-medium">{confirmText}</p>
            </div>
          )}
